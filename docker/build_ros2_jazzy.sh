...
if $REBUILD; then
    ...
    docker build --ssh default --no-cache . -t eut_ros2_jazzy:latest -f Dockerfile.ROS2Jazzy
else
    docker build --ssh default . -t eut_ros2_jazzy:latest -f Dockerfile.ROS2Jazzy
fi
